                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="/">
                            <b class="logo-icon">
                                ...
                                <!-- Light Logo icon -->
                                <img src="{{asset('adminassets/images/logo-icon.png')}}" height="50px" alt="homepage" class="light-logo" />
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                            <span class="logo-text">
                                ...
                                <!-- Light Logo text -->
                                {{-- <img src="{{asset('adminassets/images/logo-light-text.png')}}" height="40px" class="light-logo" alt="homepage" /> --}}
                            </span>
                        </a>
                    </div>
                    <!-- ============================================================== -->
